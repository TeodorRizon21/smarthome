...
export default function NewBundleForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Succes",
        description: "Bundle-ul a fost creat cu succes!",
      });
    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Adaugă detaliile generale despre bundle-ul de produse
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Adaugă imagini pentru a prezenta bundle-ul
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
      ...
      <Card className="mt-6">
        <CardHeader>
          ...
          <CardDescription>
            Selectează produsele care vor face parte din acest bundle
          </CardDescription>
        </CardHeader>
